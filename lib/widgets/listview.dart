                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Texts(n: 1, text: 'Sandy Ridge Camping Canton'),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: height * (19 / 812)),
                      const Texts(n: 2, text: 'Ev Adresi, Muğla/Menteşe'),
                      SizedBox(height: height * (18 / 812)),
                      const Texts(n: 2, text: 'İş Adresi, Muğla/Menteşe'),
                      SizedBox(height: height * (18 / 812)),
                      const Texts(n: 2, text: 'Adres, Ankara/Yenimahalle'),
                      SizedBox(height: height * (29 / 812))
                    ],
                  ),
                ),
